...
import com.example.haoss.ui.index.tourdiy.GrouponDetailActivity;
import com.example.haoss.manager.ApiManager;
import com.example.haoss.ui.pay.GoodsPayActivity;
...
//        icon.setText(String.format(getResources().getString(R.string.price_discount_unit),orderDetailsInfo.getGain_integral()));
    ...
    private void buyAgain(int goodsId) {
        IntentUtils.toGoodDetail(MyOrderDetails.this, goodsId);
    }
    ...
    private void setGoodList() {
        ...
        for (CartInfo cartInfo : orderDetailsInfo.getCartInfo()) {
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (conbination_id == 0) {
                        IntentUtils.toGoodDetail(MyOrderDetails.this, product_id);
                    } else {
