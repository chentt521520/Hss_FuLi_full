package com.example.haoss.ui.person.collect;
...
import com.example.haoss.ui.person.collect.adapter.CollectAdapter;
    ...
    private void init() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                IntentUtils.toGoodDetail(CollectListActivity.this, collectList.get(position).getProduct_id());
